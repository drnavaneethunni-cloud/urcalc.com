                ...
                <Link href="/" className="brand">
                  <span className="mark" aria-hidden="true">
                    <svg width="12" height="12" viewBox="0 0 20 20" fill="none">
                      <rect x="4.2" y="12.6" width="2.15" height="3.4" rx="1.05" fill="#FFF" />
                      <rect x="7.35" y="9.9" width="2.15" height="6.1" rx="1.05" fill="#FFF" />
                      <rect x="10.5" y="7.1" width="2.15" height="8.9" rx="1.05" fill="#FFF" />
                      <rect x="13.65" y="4.3" width="2.15" height="11.7" rx="1.05" fill="#FFF" />
                    </svg>
                  </span>
                  UrCalc
                </Link>
